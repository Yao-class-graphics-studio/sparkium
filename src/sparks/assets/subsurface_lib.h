...
enum PresetSSType: int {
    ...
    SS_REGULAR_MILK = 14,
    SS_ESPRESSO = 15,
    SS_MINT_MOCHA_COFFEE = 16,
    SS_LOWFAT_SOY_MILK = 17,
    SS_REGULAR_SOY_MILK = 18,
    SS_LOWFAT_CHOCOLATE_MILK = 19,
    SS_REGULAR_CHOCOLATE_MILK = 20,
    SS_COKE = 21,
    SS_PEPSI = 22,
    SS_SPRITE = 23,
    SS_GATORADE = 24,
    SS_CHARDONNAY = 25,
    SS_WHITE_ZINFANDEL = 26,
    SS_MERLOT = 27,
    SS_BUDWEISER_BEER = 28,
    SS_COORS_LIGHT_BEER = 29,
    SS_CLOROX = 30,
    SS_APPLE_JUICE = 31,
    SS_CRANBERRY_JUICE = 32,
    SS_GRAPE_JUICE = 33,
    SS_RUBY_GRAPE_JUICE = 34,
    SS_WHITE_GRAPEfRUITE_JUICE = 35,
    SS_SHAMPOO = 36,
    SS_STRAWBERRY_SHAMPOO = 37,
    SS_HEAD_AND_SHOULDERS_SHAMPOO = 38,
    SS_LEMON_TEE_POWDER = 39,
    SS_ORANGE_POWDER = 40,
    SS_PINK_LEMONADE_POWDER = 41,
    SS_CAPPUCCINO_POWDER = 42,
    SS_SALT_POWDER = 43,
    SS_SUGAR_POWDER = 44,
    SS_SUISSE_MOCHA_POWDER = 45,
    SS_PACIFIC_OCEAN_SURFACE_WATER = 46,
    SS_NONE = 47,
};

static PresetSS SubsurfaceParameterTable[] = {
    {"Apple", 
    {2.29, 2.39, 1.97}, 
    {0.0030, 0.0034, 0.046}},
    {"Chicken1", 
    ...
    {"Coke", 
    {8.9053e-05, 8.372e-05, 0}, 
    {0.10014, 0.16503, 0.2468}},
    {"Pepsi", 
    {6.1697e-05, 4.2564e-05, 0}, 
...
inline bool GetPresetSS(PresetSSType type, glm::vec3 &sigma_a, glm::vec3 &sigma_s) {
    if(type == SS_NONE)
        return true;
    PresetSS ss = SubsurfaceParameterTable[type];
    sigma_a = ss.sigma_a;
    sigma_s = ss.sigma_s;
    return false;
}
